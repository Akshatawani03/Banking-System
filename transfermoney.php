...
<body>
    ...
    <div class="container">
        ...
        <br>
        <div class="row shadow text-center" style="background-color: #17202A;">
            <div class="col">
                <div class="table-responsive-sm pt-3">
                    <table class="table table-hover table-sm  table-condensed table-bordered" style="border-color:white;">
