...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="row intro py-1 bg ">
      <div class="col-sm-12 col-md">
        <div class="heading text-center my-5" style="color: #225991;">
          <h1>Welcome To Bank of India</h1>
          
        </div>
      </div>
      <div class="col-sm-12 col-md img text-center">
        <img src="4.jpeg" class="img-fluid pt-2" style="width:350px;">
      </div>
    </div>
  ...
  <footer class="text-center mt-5 py-2">
    <p style="font-family:  antonio; font-size: 19px;">&copy 2021. Developed by <b>Akshata Wani  </b> <br> Sparks Foundation</p>
  </footer>
